...
def run_motif_enrichment(clust_out, ref_bed, ref_fa, ref_motif,
                         ame, up_dist=100, down_dist=100):
    '''
    Wrapper function that parses out genes and extracts
    promoter sequence from reference files
    '''
